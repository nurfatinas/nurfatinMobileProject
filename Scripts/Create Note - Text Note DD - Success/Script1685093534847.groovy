...
inputTitle = CustomKeywords.'master.randomNumber.genRandomNumber'(input_Title_forNote, 4)

Mobile.setText(findTestObject('Object Repository/createNote/simpleNote/input_Title_forNote'), inputTitle, 0)

Mobile.setText(findTestObject('Object Repository/createNote/simpleNote/input_Description_forNote'), input_Text_forNote, 
    0)
